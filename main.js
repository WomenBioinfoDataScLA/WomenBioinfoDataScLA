...
const MembersList = [
    ...
    { "name": "Ivana Feldfeber", 'img': 'ivana.jpg', "filiation": "Mumuki Project, Argentina" },
    { "name": "Augustina Nardo", 'img': 'cabeza.png', "filiation": "Argentina" }
];
...
function renderconductSection() {
    ...
    conductSection.appendChild(secDiv);
